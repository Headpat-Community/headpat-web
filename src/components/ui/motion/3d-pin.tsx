...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="z-60 pointer-events-none flex h-80 w-96 items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          ...
          >
            ...
            <span className="bg-linear-to-r absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] from-emerald-400/0 via-emerald-400/90 to-emerald-400/0 transition-opacity duration-500 group-hover/btn:opacity-40"></span>
          </a>
        </div>
        ...
        <>
          <motion.div className="bg-linear-to-b absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] from-transparent to-cyan-500 blur-[2px] group-hover/pin:h-40" />
          <motion.div className="bg-linear-to-b absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] from-transparent to-cyan-500 group-hover/pin:h-40" />
