...
import { editUserData, editUserEmail, editUserPassword, handleNsfwChange, } from '../../../utils/actions/user-actions';

export default function AccountPage({userDataSelf, userSelf, userId}) {
	const [userData, setUserData] = useState(userDataSelf || []);
	const [userMe, setUserMe] = useState(
		userSelf || {enablensfw: false});
	...
	const handleNsfw = async (event) => {
		...
		try {
			...
			if (putResponse) {
				...
				setUserMe(
					(prevUserData) => ({...prevUserData, enablensfw: isChecked}));
			} else {
