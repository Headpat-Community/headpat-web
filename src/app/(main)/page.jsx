      ...
      <div className="bg-transparent">
        <div className="relative isolate pt-14">
          ...
          >
            ...
            <svg x="50%" y={-1}
                 className="overflow-visible dark:fill-gray-50 fill-black">
              <path
          ...
          <div
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div
                  className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600  ring-1 dark:ring-white/30 ring-black/30 dark:hover:ring-white/50 hover:ring-black/50">
                  <svg
                  ...
                  <span
                    className="font-semibold text-indigo-500">Discord</span>
                  <span className="h-4 w-px dark:bg-white/90 bg-black/90"
                        aria-hidden="true"/>
                  <Link
