            ...
            <main>
                ...
                >
                    <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
                        ...
                        >
                            <div
                                className="pointer-events-auto w-full max-w-sm rounded-lg shadow-lg ring-1 dark:bg-black bg-white dark:ring-black ring-white ring-opacity-5 border dark:border-white border-black">
                                <div className="p-4">
                                ...
                                <div
                                    ...
                                    <div className="flex items-center gap-x-4 sm:gap-x-6">
                                        ...
                                        <Menu as="div" className="relative sm:hidden">
                                            ...
                                            >
                                                <Menu.Items
                                                    className="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-white/5 focus:outline-none">
                                                    <Menu.Item>
                                                        {({active}) => (
                                                            <>
                                                                <Link
                        ...
                        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                            <div
                                ...
                                <div className="lg:col-start-3 lg:row-end-1">
                                    ...
                                    <div
                                        className="rounded-lg border shadow-sm ring-1 dark:ring-white/20 ring-black/20">
                                ...
                                {/* Biography */}
                                <div
                                    className="-mx-4 px-4 py-8 shadow-sm ring-1 dark:ring-white/95 ring-black/95 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
                                            ...
                                            >
                                                ...
                                                {activityItem.type === "commented" && (
                                                    <>
                                                        ...
                                                        />
                                                        <div
                                                            className="flex-auto rounded-md p-3 ring-1 ring-inset dark:ring-gray-200 ring-gray-700">
                                  ...
                                  <span className="font-medium">
                                    ...
                                    <div className="mt-6 flex gap-x-3">
                                        ...
                                        <form action="#" className="relative flex-auto">
                                            <div
                                                className="overflow-hidden rounded-lg pb-12 shadow-sm ring-1 ring-inset dark:ring-gray-300 ring-gray-800 focus-within:ring-2 focus-within:ring-indigo-600">
                                                            ...
                                                            {({open}) => (
                                                                <>
                                                                    ...
                                                                    <div className="relative">
                                                                        <Listbox.Button
                                                                            className="relative -m-2.5 flex h-10 w-10 items-center justify-center rounded-full dark:text-gray-400 text-gray-900 hover:text-gray-500">
                                        ...
                                        {selected.value === null ? (
                                            ...
                                            <span className="sr-only">
                                              {selected.name}
                                                                        ...
                                                                        >
                                                                            <Listbox.Options
                                                                                className="absolute z-10 -ml-6 mt-1 w-60 rounded-lg py-3 text-base shadow focus:outline-none sm:ml-auto sm:w-64 sm:text-sm">
                                                                                {moods.map((mood) => (
                                                                                    <Listbox.Option
                                                                                        key={mood.value}
                                                                                        className={({active}) =>
                                                                                    ...
                                                                                    >
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                className="ml-3 block truncate font-medium dark:text-black text-white">
                                                {mood.name}
                                              </span>
                                                                                        </div>
                                                                                    </Listbox.Option>
