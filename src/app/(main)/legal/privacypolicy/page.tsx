    ...
    <>
      <div className="px-6 py-32 lg:px-8">
        <div className="container mx-auto p-4">
          ...
          <p className="text-gray-600">Last updated September 13, 2023</p>
          <p className="mt-4">
            This privacy notice for Headpat (&quot;we,&quot; &quot;us,&quot; or
          ...
          <ul className="list-disc list-inside ml-4">
            ...
            <li>
              Download and use our mobile application (Headpat), or any other
          ...
          <p className="mt-2">
            ...
            use.{' '}
            <a href="#information-we-collect" className="text-blue-500">
          ...
          <p className="mt-2">
            ...
            <a href="#how-we-process" className="text-blue-500">
          ...
          <p className="mt-2">
            ...
            third parties.{' '}
            <a href="#sharing-information" className="text-blue-500">
          ...
          <p className="mt-2">
            ...
            <a href="#keeping-info-safe" className="text-blue-500">
          ...
          <p className="mt-2">
            ...
            information.{' '}
            <a href="#your-rights" className="text-blue-500">
          ...
          <p className="mt-4">
            ...
            <a href="#full-privacy-notice" className="text-blue-500">
          ...
          <ul className="list-decimal list-inside ml-4">
            ...
            <li>
              <a href="#social-logins" className="text-blue-500">
                HOW DO WE HANDLE YOUR SOCIAL LOGINS?
              </a>
            </li>
            <li>
              <a href="#info-retention" className="text-blue-500">
            ...
            <li>
              <a href="#collecting-minors-info" className="text-blue-500">
            ...
            <li>
              <a href="#dnt-features" className="text-blue-500">
                CONTROLS FOR DO-NOT-TRACK FEATURES
              </a>
            </li>
            <li>
              <a href="#california-rights" className="text-blue-500">
                DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
              </a>
            </li>
            <li>
              <a href="#virginia-rights" className="text-blue-500">
                DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
              </a>
            </li>
            <li>
              <a href="#policy-updates" className="text-blue-500">
            ...
            <li>
              <a href="#data-review" className="text-blue-500">
          ...
          <h3 className="text-xl font-semibold mb-2">CCPA Privacy Notice</h3>
          <p className="mb-4">
